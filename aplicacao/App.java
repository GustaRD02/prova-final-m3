    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        do {
            ...
            if (opcao == 2) {
                ...
                List<Produto> findProduto = produtos.stream().filter(produto -> produto.getCodigo() == searchCode)
            ...
            if (opcao == 3) {
                ...
                System.out.printf("\nValor máximo: %.2f | Valor mínimo: %.2f | Valor da média: %.2f", valorMaximo,
                        valorMinimo, media);
            ...
            if (opcao == 4) {
                if (vendas.isEmpty()) {
                    ...
                    Map<LocalDate, List<Venda>> relatorioVendas = vendas.stream()
                    ...
                    Map<LocalDate, Double> valoresMedios = vendas.stream().collect(
                            Collectors.groupingBy(Venda::getData, Collectors.averagingDouble(Venda::getValorTotal)));
                    valoresMedios.entrySet()
                            .forEach(venda -> System.out.printf("\n\nData: %s  \nValor médio no período: %.2f",
                                    venda.getKey().format(df), venda.getValue()));
                }
